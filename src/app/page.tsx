...
export default function Home() {
  return (
    <div className="relative cursor-auto max-md:pt-20">
          ...
          <div className="flex flex-col items-center justify-center gap-10 max-w-[760px]">
            ...
            <div className="flex flex-col items-center justify-center gap-12">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <Button label="Download Resume" type="primaryBorder" onClick={() => window.open("https://drive.google.com/file/d/1PTQQkHypBje_i25PfA85NTrWWQCiIdZm/view?usp=sharing", "_blank")} />
      ...
      <div className="w-screen relative left-1/2 right-1/2 -mx-[50vw] bg-[var(--bg-secondary)]">
        <div className="max-w-screen-xl mx-auto w-full">
          <motion.div
            ...
            <div
              className="flex flex-col gap-8 md:gap-10 md:px-18 px-8 py-24 align-middle"
            >
      ...
      <motion.div
        id="about"
        className="py-24 px-8 flex flex-col gap-16 md:gap-20 items-center justify-center"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: 'easeOut' }}
        viewport={{ once: false, amount: 0.2 }}
      ...
      <motion.div
        id="skills"
        className="flex flex-col py-24 px-8 gap-10"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: 'easeOut' }}
        viewport={{ once: false, amount: 0.2 }}
