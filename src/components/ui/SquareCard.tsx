...
export function SquareCard({ icon, title, body }: { icon: string, title: string, body: string }) {
    return (
        <motion.div
            ...
            className="w-full"
        >
            <div className="flex flex-col gap-6 sm:gap-7 md:gap-9 px-4 sm:px-6 md:px-8 py-6 sm:py-7 md:py-9 rounded-[var(--card-uxui-radius)] bg-[var(--card-uxui-bg)] w-full max-w-[380px] min-h-[240px] sm:min-h-[260px] md:h-[268px] mx-auto">
