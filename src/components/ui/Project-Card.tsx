...
export function ProjectCard({
    ...
    return (
        <motion.div
            ...
            whileTap={{ scale: 0.98 }}
        >
            <div className="cursor-pointer relative bg-(--card-project-bg) shadow-white/40 rounded-3xl gap-3 flex flex-col overflow-hidden w-[322px] h-[450px] md:w-[372px] md:max-w-[372px] md:h-[500px] border-(--topbar-divider-border) border">
                ...
                <div className="relative p-6 flex flex-col gap-3">
                    <p className="text-2xl font-semibold text-(--card-project-label-title)">{title}</p>
                    <div className="flex flex-col gap-3">
                        <p className="text-base font-normal text-(--card-project-label-body)">{description}</p>
