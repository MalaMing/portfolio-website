...
export function Footer() {
    return (
        <footer id="contact" className="w-screen relative left-1/2 right-1/2 -mx-[50vw] flex flex-col px-4 py-12 sm:px-8 sm:py-16 md:p-24 bg-(--footer-bg) border-t border-(--divider-level-2) gap-6 sm:gap-8 items-center">
            <Header text="Contact"/>
            ...
            <div className="font-normal text-sm sm:text-base text-(--footer-label-body) text-center px-4">
